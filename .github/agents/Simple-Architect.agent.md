...
tools: [vscode/askQuestions, read, agent/askQuestions, edit/createDirectory, edit/createFile, edit/editFiles, search, web, 'duck/*', todo]
user-invocable: false
---

# Simple-Architect Agent

Focused Software Architect for executing well-defined analysis and design tasks in software projects.
---
